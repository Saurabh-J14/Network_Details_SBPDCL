...
import com.techLabs.nbpdcl.databinding.FragmentSwitchDialogBinding;
...
public class SwitchDialogFragment extends Fragment {

    private FragmentSwitchDialogBinding binding;
    ...
    public SwitchDialogFragment(String networkId, int location) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSwitchDialogBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (ResponseDataUtils.checkInternetConnectionAndInternetAccess(requireActivity())) {
            getSwitchEquipment(networkId, "Switch");
        } else {
            Snackbar.make(binding.getRoot(), "No Internet Connection", Snackbar.LENGTH_LONG).show();
        }

        Args.getIsSwitchValidate().observe(getViewLifecycleOwner(), new Observer<Boolean>() {
            @Override
    ...
    private void getSwitchEquipment(String networkId, String aSwitch) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("NetworkId", networkId);
        jsonObject.addProperty("Type", "Equipment");
        jsonObject.addProperty("Subtype", aSwitch);
            ...
            public void onResponse(@NonNull Call<EquipmentModel> call, @NonNull Response<EquipmentModel> response) {
                if (response.code() == 200) {
                    ...
                    Ok.setOnClickListener(v -> {
                        getSwitchEquipment(networkId, aSwitch);
                    });
    ...
    private void checkDetails() {
        ...
        if (isCancel) {
            ...
            if (binding != null && binding.deviceNumbersEdt.getText() != null && binding.locationSpinnersBar.getSelectedItem() != null && binding.statusSpinnersBar.getSelectedItem() != null && binding.equipIdSpinnerBar.getText() != null) {
                ...
                bundle.putString("DeviceType", "13");
                ...
                Args.setSwitchParameter(bundle);
            }
        }
