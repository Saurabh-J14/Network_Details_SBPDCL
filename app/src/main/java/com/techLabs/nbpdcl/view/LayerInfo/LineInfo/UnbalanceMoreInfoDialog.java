...
import com.techLabs.nbpdcl.databinding.UnbalanceinfoLayoutBinding;
...
public class UnbalanceMoreInfoDialog extends Dialog implements SectionCallBack, IsCancel, Update {
    ...
    public UnbalanceMoreInfoDialog(@NonNull Context context, String sectionId, IsCancel isCancel, String networkID, JsonObject jsonObject, String voltage) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sectionTv.setEnabled(false);

        ViewPager2 viewPager = binding.viewPager;
        TabLayout tabLayout = binding.tablayout;
        adapter = new DynamicFragmentAdapter((FragmentActivity) mainContext);
        adapter.addFragment(new UnbalanceDetailFragment(this, this, networkId, jsonObject), "UnBalance");
        deviceSize.put("UnBalance", 2);
        insertedDevices.put("UnBalance", 23);
        ...
        binding.RemoveDevice.setOnClickListener(v -> {
            if (!adapter.getPageTitle(tabPosition).equals("UnBalance") && !adapter.getPageTitle(tabPosition).equals("Node")) {
        ...
        binding.okbtn.setOnClickListener(v -> {
            ...
            /* if (!insertDevices.keySet().isEmpty()) {
                CheckDetails();
            }*/
        });
                        ...
                        if (findDeviceModel.getOutput() != null && !findDeviceModel.getOutput().isEmpty()) {
                            for (int i = 0; i < findDeviceModel.getOutput().size(); i++) {
                                if (findDeviceModel.getOutput().get(i).getDeviceType() == 8) {
                                    ...
                                    adapter.addFragment(new BreakerFragment(UnbalanceMoreInfoDialog.this, UnbalanceMoreInfoDialog.this,networkId,voltage, jsonObject2), "Breaker");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new ShuntCapacitorFragment(UnbalanceMoreInfoDialog.this, jsonObject2), "ShuntCapacitor");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new FuseFragment(UnbalanceMoreInfoDialog.this,UnbalanceMoreInfoDialog.this,voltage, jsonObject2), "Fuse");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new SpotloadFragment(UnbalanceMoreInfoDialog.this, jsonObject2), "SpotLoad");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new SwitchFragment(UnbalanceMoreInfoDialog.this,UnbalanceMoreInfoDialog.this,networkId,"", jsonObject2), "Switch");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new TransformerFragment(UnbalanceMoreInfoDialog.this, UnbalanceMoreInfoDialog.this, UnbalanceMoreInfoDialog.this, networkId, "", jsonObject2), "Transformer");
                                    insertedDevices.put("Transformer", 5);
