...
public class TransformerSnippet extends Dialog implements IsCancel {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            TransformerDialog transformerDialog = new TransformerDialog(mainContext, this, NetworkId, voltage, jsonObject);
