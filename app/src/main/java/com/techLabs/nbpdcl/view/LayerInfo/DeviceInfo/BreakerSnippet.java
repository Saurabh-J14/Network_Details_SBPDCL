...
public class BreakerSnippet extends Dialog implements IsCancel {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            BreakerDialog breakerDialog = new BreakerDialog(mainContext, this,NetworkId, voltage, jsonObject);
            breakerDialog.show();
        });
