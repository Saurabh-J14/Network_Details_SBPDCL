...
public class CableMoreInfoDialog extends Dialog implements SectionCallBack, IsCancel, Update {
    ...
    public CableMoreInfoDialog(@NonNull Context context, IsCancel isCancel, String networkId, String sectionId, String voltage, JsonObject jsonObject) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addFragment(new CableFragment(mainContext, this, this, networkId, voltage, jsonObject), "Cable");
        deviceSize.put("Cable", 1);
        insertedDevices.put("Cable", 1);
        ...
        binding.RemoveDevice.setOnClickListener(v -> {
            List<String> list = new ArrayList<>(insertedDevices.keySet());
            PopupMenu popupMenu = new PopupMenu(mainContext, v);
            for (String item : list) {
                if (item.equals("Node") || item.equals("Cable")) {
                    continue;
                } else {
                    popupMenu.getMenu().add(Menu.NONE, item.indexOf(item), item.indexOf(item), item);
                }

            }
            popupMenu.setOnMenuItemClickListener(item -> {
                Toast.makeText(mainContext, "Clicked", Toast.LENGTH_LONG).show();
                return true;
            });
            popupMenu.show();
        });
                        ...
                        if (findDeviceModel.getOutput() != null && !findDeviceModel.getOutput().isEmpty()) {
                            for (int i = 0; i < findDeviceModel.getOutput().size(); i++) {
                                if (findDeviceModel.getOutput().get(i).getDeviceType() == 8) {
                                    ...
                                    adapter.addFragment(new BreakerFragment(CableMoreInfoDialog.this,CableMoreInfoDialog.this, networkId,voltage, jsonObject2), "Breaker");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new ShuntCapacitorFragment(CableMoreInfoDialog.this, jsonObject2), "ShuntCapacitor");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new FuseFragment(CableMoreInfoDialog.this,CableMoreInfoDialog.this, voltage, jsonObject2), "Fuse");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new SpotloadFragment(CableMoreInfoDialog.this, jsonObject2), "SpotLoad");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new SwitchFragment(CableMoreInfoDialog.this,CableMoreInfoDialog.this,networkId,voltage, jsonObject2), "Switch");
                                    ...
                                    jsonObject2.addProperty("DeviceNumber", findDeviceModel.getOutput().get(i).getDeviceNumber());
                                    jsonObject2.addProperty("DeviceType", findDeviceModel.getOutput().get(i).getDeviceType().toString());
                                    adapter.addFragment(new TransformerFragment(CableMoreInfoDialog.this, CableMoreInfoDialog.this, CableMoreInfoDialog.this, networkId, voltage, jsonObject2), "Transformer");
                                    insertedDevices.put("Transformer", 5);
    ...
    @Override
    public void OnCableDataReceived(String sectionID, String phase, String fromNodeId, String fromX, String fromY, String toNodeID, String toNodeX, String toNodeY, String DeviceLineNumber, String DeviceTypeLine) {
