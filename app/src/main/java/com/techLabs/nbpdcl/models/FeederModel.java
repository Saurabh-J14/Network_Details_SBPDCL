...
public class FeederModel {
    ...
    public class Output {
        ...
        public class Networkinfo {
            ...
            @Expose
            private List<MainFeeder.VoltageWise> voltageWise;
            ...
            public List<MainFeeder.VoltageWise> getVoltageWise() {
                return voltageWise;
            }

            public void setVoltageWise(List<MainFeeder.VoltageWise> voltageWise) {
